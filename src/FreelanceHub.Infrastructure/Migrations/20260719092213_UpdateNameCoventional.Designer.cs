...
namespace FreelanceHub.Infrastructure.Migrations
{
    ...
    [Migration("20260719092213_UpdateNameCoventional")]
    partial class UpdateNameCoventional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FreelanceHub.Domain.Models.FreelancerProfile", b =>
                {
                    ...
                    b.ToTable("freelancer_profiles", null, t =>
                        {
                            t.HasCheckConstraint("chk_freelancer_profiles_availability_status", "[availability_status] IS NULL OR [availability_status] IN (20, 21, 22)");

                            t.HasCheckConstraint("chk_freelancer_profiles_experience_level", "[experience_level] IS NULL OR [experience_level] IN (30, 31, 32)");
                        });
                });
            ...
            modelBuilder.Entity("FreelanceHub.Domain.Models.Application", b =>
                {
                    b.HasOne("FreelanceHub.Domain.Models.FreelancerProfile", null)
