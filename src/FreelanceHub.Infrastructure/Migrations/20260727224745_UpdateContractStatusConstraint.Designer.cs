...
namespace FreelanceHub.Infrastructure.Migrations
{
    ...
    [Migration("20260727224745_UpdateContractStatusConstraint")]
    partial class UpdateContractStatusConstraint
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("contracts", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("chk_contracts_status", "[contract_status] IN (60, 61, 62, 63, 64,65)");
                        });
                });
