...
namespace FreelanceHub.Infrastructure.Migrations
{
    ...
    [Migration("20260728040933_AddNotifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FreelanceHub.Domain.Models.ChatMessage", b =>
                {
                    ...
                    b.HasIndex("ApplicationId", "SentAt", "ChatMessageId");
            ...
            modelBuilder.Entity("FreelanceHub.Domain.Models.Notification", b =>
                {
                    ...
                    b.HasIndex("RecipientUserId", "GroupKey")
                        .IsUnique()
            ...
            modelBuilder.Entity("FreelanceHub.Domain.Models.ChatMessage", b =>
                {
                    ...
                    b.HasOne("FreelanceHub.Domain.Models.ApplicationUser", "SenderUser")
            ...
            modelBuilder.Entity("FreelanceHub.Domain.Models.Notification", b =>
                {
                    b.HasOne("FreelanceHub.Domain.Models.ApplicationUser", "ActorUser")
                        .WithMany()
                        .HasForeignKey("ActorUserId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("FreelanceHub.Domain.Models.ApplicationUser", "RecipientUser")
